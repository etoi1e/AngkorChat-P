 ...
 * Use the [EmojiStoreMyEmojiFragment.newInstance] factory method to
...
class EmojiStoreMyEmojiFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EmojiStoreMyEmojiFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EmojiStoreMyEmojiFragment().apply {
