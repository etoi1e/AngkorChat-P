...
class SettingsChattingFragment : Fragment() {
    lateinit var binding: FragmentSettingsChattingBinding
    ...
    override fun onResume() {
        super.onResume()
        Log.d("FragmentSettingsChattingBinding", "onResume")
    }
    ...
    override fun onCreateView(
        ...
        Log.d("FragmentSettingsChattingBinding", "onCreateView")
        binding = FragmentSettingsChattingBinding.inflate(inflater, container, false)
