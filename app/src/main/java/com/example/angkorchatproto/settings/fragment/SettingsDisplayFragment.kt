...
import com.example.angkorchatproto.databinding.FragmentSettingsDisplayBinding
...
class SettingsDisplayFragment : Fragment() {
    lateinit var binding: FragmentSettingsDisplayBinding
    ...
    override fun onResume() {
        super.onResume()
        Log.d("FragmentSettingsDisplayBinding", "onResume")
    }
    ...
    override fun onCreateView(
        ...
        Log.d("FragmentSettingsDisplayBinding", "onCreateView")
