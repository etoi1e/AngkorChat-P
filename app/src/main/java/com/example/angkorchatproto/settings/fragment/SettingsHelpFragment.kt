...
import com.example.angkorchatproto.databinding.FragmentSettingsHelpBinding
...
class SettingsHelpFragment : Fragment() {
    lateinit var binding: FragmentSettingsHelpBinding
    ...
    override fun onResume() {
        super.onResume()
        Log.d("FragmentSettingsHelpBinding", "onResume")
    }
    ...
    override fun onCreateView(
        ...
        Log.d("FragmentSettingsHelpBinding", "onCreateView")
        binding = FragmentSettingsHelpBinding.inflate(inflater, container, false)
