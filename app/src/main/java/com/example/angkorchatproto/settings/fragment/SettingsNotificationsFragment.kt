...
import com.example.angkorchatproto.databinding.FragmentSettingsNotificationsBinding
...
class SettingsNotificationsFragment : Fragment() {
    lateinit var binding: FragmentSettingsNotificationsBinding
    ...
    override fun onResume() {
        super.onResume()
        Log.d("FragmentSettingsNotificationsBinding", "onResume")
    }
    ...
    override fun onCreateView(
        ...
        Log.d("FragmentSettingsNotificationsBinding", "onCreateView")
